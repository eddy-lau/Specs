Pod::Spec.new do |spec|
  ...
  spec.preserve_paths = 'Dummy/Pods/AccountKit/AccountKit.framework'
  spec.user_target_xcconfig = { 'FRAMEWORK_SEARCH_PATH' => '$PODS_ROOT/UXParseAccountKitClient/Dummy/Pods/AccountKit' }
